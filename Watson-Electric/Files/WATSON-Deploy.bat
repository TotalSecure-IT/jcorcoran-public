...
if exist "C:\Program Files\PowerShell\7\pwsh.exe" (
    ...
    "C:\Program Files\PowerShell\7\pwsh.exe" -ExecutionPolicy Bypass -File "C:\WATSON-Deployment\Files\WATSON-Deploy.ps1"
    exit /b
)
...
powershell.exe -ExecutionPolicy Bypass -File "C:\WATSON-Deployment\Files\WATSON-Deploy.ps1"
